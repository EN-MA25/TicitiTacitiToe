 ...
 * Use the [FriendsLeaderboardFragment.newInstance] factory method to
...
class FriendsLeaderboardFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment FriendsLeaderboardFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            FriendsLeaderboardFragment().apply {
